...
- «Найди в паке риторики приём для поста про привычки»
- «Подбери аналогию, чтобы объяснить системное мышление новичку»
- «Какие кейсы есть про обучение взрослых?»
- «Дай контрпример к возражению „у меня нет времени на развитие"»

**Чего здесь нет:** готовых текстов постов (только приёмы-заготовки) и знания о предметных областях — за этим в профильные паки (PACK-ecosystem, PACK-MIM).
