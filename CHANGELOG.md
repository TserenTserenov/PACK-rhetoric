...
### Добавлено
- 66 карточек из all-time topics mining (RHE.ILL.120–193): режим topics, `/latest.json?order=views`
- 22 топика квалифицированы, 28 постов прошли post-фильтр, 18 мин прогон
- Топ-источник: post/2085 (incoming_link_count=1141) — «Как встроиться в деятельность ШСМ?»
- Итого: 183 active + 11 pending карточек

### Исправлено
- `rhetoric-miner.py`: dry-run больше не обновляет checkpoint (бесшумно блокировал реальный прогон)
